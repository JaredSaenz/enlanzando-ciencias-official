    ...
    <div className="bg-white min-h-screen">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto h-full flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <h1 className="text-4xl font-extrabold text-white sm:text-5xl md:text-6xl mb-4">Conferencias</h1>
      ...
      <div ref={contentRef} className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <AnimatedSection>
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-[#552673] mb-4">Nuestras Conferencias</h2>
            <p className="text-lg text-gray-700">
              Explora nuestras conferencias educativas donde expertos comparten conocimientos científicos de manera
              accesible y comprensible.
            </p>
          </div>
          <SectionList section="conferencias" />
        </AnimatedSection>
      </div>
    </div>
  )
