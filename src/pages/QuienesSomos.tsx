        ...
        <AnimatedSection>
          <div className="mt-16">
            ...
            <div className="relative" style={{ paddingTop: '56.25%' }}>
              <iframe
                src="https://www.facebook.com/plugins/video.php?href=https://www.facebook.com/Enlazando.ciencias/videos/descubre-el-fascinante-mundo-de-la-ciencia-con-enlazando-ciencias-estamos-compro/341695948691977/&show_text=false&width=500"
                width="500"
                height="281"
